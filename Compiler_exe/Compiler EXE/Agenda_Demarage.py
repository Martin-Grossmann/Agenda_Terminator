...
from PyQt5.QtWidgets import QMainWindow, QGraphicsDropShadowEffect, QApplication, QTableWidget, QTableWidgetItem, QDialog
...
class Agenda_Demarage(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QtGui.QIcon('Agenda.png'))
    ...
    def Recherche_JsonFile(self):
        ...
        #Extraction JSON:
        self.PATH_Event = self.current_path+'/Agenda_Terminator_JSON.json'
        with open(self.PATH_Event) as json_data:
    ...
    def Suppression_old_Datas(self):
        ...
        if self.CompareLenList != 0:
            ...
            self.PATH_Event = self.current_path+'/Agenda_Terminator_JSON.json'
            with open(self.PATH_Event, "w") as file:
                json.dump(self.json_data, file, indent=4, sort_keys=False)        
    ...
    def Incorporation_dynamique(self):
        ...
        for x in self.List:           
            for i in range(0, self.len_List):            
                ...
                # 2.) Size:
                self.label_2.setMinimumSize(QtCore.QSize(100, 10))         # Largeur/hauteur
                self.label_2.setMaximumSize(QtCore.QSize(800, 70))         # Largeur/hauteur
